...
class Strategy(DataLoading):
    ...
    def __init__(self):
        super().__init__()
        self.hist_data = self.get_historical_data("BTCUSDT", "1d", "1-1-2021", "30-3-2022")
    ...
    def stg_smma(self):
        ...
        df["teeth"] = self.smma_logic(df["hl2"], 14).shift(3)
        df["lips"] = self.smma_logic(df["hl2"], 9).shift(3)
